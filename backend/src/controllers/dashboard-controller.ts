...
export const getLatestRepairs = async (req: Request, res: Response) => {

    logger.info("Start: get latest repairs for dashboard.");

    try {
        const response = await dashboardService.getLatestRepairs();
